...
inline float BNParameter::var_eps() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.var_eps)
  return var_eps_;
}
inline void BNParameter::set_var_eps(float value) {
  set_has_var_eps();
  var_eps_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.var_eps)
}
...
inline bool BNParameter::moving_average() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.moving_average)
  return moving_average_;
}
inline void BNParameter::set_moving_average(bool value) {
  set_has_moving_average();
  moving_average_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.moving_average)
}
...
inline float BNParameter::decay() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.decay)
  return decay_;
}
inline void BNParameter::set_decay(float value) {
  set_has_decay();
  decay_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.decay)
}
